...
create_view ZNW_ORD_ITEMS_V    "Northwind Order Items (orders+details+customers+products)" znw_ord_items_v.ddls
...
echo "  Joined view:        ZNW_ORD_ITEMS_V (orders + details + customers + products)"

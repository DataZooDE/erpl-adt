  ...
  METHOD if_oo_adt_classrun~main.
    ...
    lt_data = VALUE #(
      ...
      ( supplier_id = 10
        ...
        phone = '(11) 555 4640' )
      ( supplier_id = 11
        company_name = 'Heli Susswaaren GmbH & Co. KG'
        contact_name = 'Petra Winkler'
        contact_title = 'Sales Manager'
        address = 'Tiergartenstrasse 5'
        city = 'Berlin'
        region = ''
        postal_code = '10785'
        country = 'Germany'
        phone = '(010) 9984510' )
      ( supplier_id = 12
        company_name = 'Plutzer Lebensmittelgrossmarkte AG'
        ...
        phone = '(069) 992755' )
      ( supplier_id = 13
        company_name = 'Nord-Ost-Fisch Handelsgesellschaft'
